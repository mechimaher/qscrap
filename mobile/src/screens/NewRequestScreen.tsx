...
const styles = StyleSheet.create({
    ...
    closeText: { fontSize: 24, color: Colors.dark.text },
    ...
    vinInput: { flex: 1, backgroundColor: Colors.dark.surface, borderRadius: BorderRadius.md, padding: Spacing.md, fontSize: FontSizes.md, color: Colors.dark.text, borderWidth: 1, borderColor: Colors.dark.border, height: 50 },
    scanButton: { height: 50, borderRadius: BorderRadius.md, overflow: 'hidden' },
    ...
    conditionText: { fontSize: FontSizes.md, color: Colors.dark.textSecondary },
    ...
    imageButtonText: { fontSize: FontSizes.md, color: Colors.dark.text },
    ...
    feeAmount: { fontSize: FontSizes.lg, fontWeight: '700', color: Colors.primary },
    ...
    submitText: { fontSize: FontSizes.lg, fontWeight: '700', color: '#fff' },
});
