...
const TERMS_URL = 'https://qscrap.qa/terms.html';

/**
 * Terms of Service Screen
 * Loads live terms from website — single source of truth.
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
            <View style={[styles.header, { borderBottomColor: colors.border, flexDirection: rtlFlexDirection(isRTL) }]}>
                ...
                <Text style={[styles.title, { color: colors.text }]}>{t('settings.terms')}</Text>
                <View style={{ width: 40 }} />
            </View>
