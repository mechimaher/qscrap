...
const SECTIONS_EN: SectionBase[] = [
    {
        ...
        content:
            'By accessing or using the QScrap mobile applications, website, or related services (collectively, the "Platform"), you agree to be legally bound by these Terms of Service. If you do not agree, you must not use the Platform.'
    },
    {
        num: 2,
        title: 'Eligibility',
        ...
        content:
            'You must have full legal capacity under the laws of your country of residence and be at least 18 years old to use the Platform.'
    },
    {
        num: 3,
    ...
    },
    {
        ...
        content:
            'To the maximum extent permitted by law, QScrap shall not be liable for indirect or consequential damages arising from Platform use. Nothing in these Terms excludes liability for:',
        items: [
    ...
    },
    {
        ...
        content:
            'QScrap is not liable for failure or delay caused by events beyond reasonable control, including government actions, telecom outages, fuel shortages, cyber incidents, or extreme weather.'
    },
    {
        num: 10,
    ...
    },
    {
        ...
        content:
            'QScrap may update these Terms at any time. Continued use of the Platform constitutes acceptance of the updated Terms.'
    },
    {
        num: 13,
        title: 'Contact',
...
const SECTIONS_AR: SectionBase[] = [
    {
        ...
        icon: 'document-text' as const,
        content:
            'باستخدامك لتطبيقات أو موقع كيوسكراب أو أي من خدماتها الإلكترونية («المنصة الإلكترونية»)، فإنك توافق على الالتزام القانوني بهذه الشروط. وإذا لم توافق، يجب عليك عدم استخدام المنصة.'
    },
    {
        num: 2,
    ...
    },
    {
        ...
        icon: 'alert-circle' as const,
        content:
            'إلى أقصى حد يسمح به القانون، لا تتحمل كيوسكراب المسؤولية عن الأضرار غير المباشرة أو التبعية الناتجة عن استخدام المنصة. ولا يسري أي استبعاد للمسؤولية على:',
        items: ['الغش أو التدليس', 'الإهمال الجسيم', 'الوفاة أو الإصابة الجسدية', 'حقوق المستهلك المقررة قانونًا']
    },
    {
        num: 9,
        title: 'القوة القاهرة',
        icon: 'thunderstorm' as const,
        content:
            'لا تتحمل كيوسكراب المسؤولية عن أي تأخير أو إخفاق ناتج عن ظروف خارجة عن السيطرة، بما في ذلك القرارات الحكومية أو انقطاع الاتصالات أو نقص الوقود أو الهجمات السيبرانية أو الأحوال الجوية الشديدة.'
    },
    {
        num: 10,
...
const CHROME = {
    ...
    ar: {
        ...
        summaryText:
            'تحكم شروط الخدمة هذه استخدامك لمنصة كيوسكراب التي تديرها شركة كيوسكراب للخدمات والتجارة ذ.م.م. بتحميلك أو استخدامك لتطبيقاتنا وخدماتنا، فإنك توافق على الالتزام بهذه الشروط.',
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
            ...
            >
                                    ...
                                    styles.highlightBox,
                                    {
                                        backgroundColor: isDark
                                            ...
                                            : section.highlight.type === 'gold'
                                              ...
                                              : '#FAF0F3',
                                        borderStartColor:
                                            section.highlight.type === 'gold' ? Colors.secondary : Colors.primary
                                    }
                                ]}
                            >
                                <Ionicons
                ...
                {/* Footer */}
                <Text style={[styles.footer, { color: colors.textMuted }]}>{chrome.footer}</Text>
            </ScrollView>
        </SafeAreaView>
    );
}
