...
const SECTIONS_EN = [
    ...
    },
    {
        ...
        items: [
            ...
            'All parts carry a standard 7-day warranty from date of delivery',
            'The 7-day warranty applies equally to new and used parts of all conditions',
            'Disputes must be raised within the 7-day warranty period',
...
const SECTIONS_AR = [
    ...
    },
    {
        ...
        items: [
            ...
            'جميع القطع تحمل ضمان موحد لمدة 7 أيام من تاريخ التسليم',
            'ضمان 7 أيام ينطبق بالتساوي على القطع الجديدة والمستعملة بجميع حالاتها',
            'يجب رفع النزاعات خلال فترة الضمان البالغة 7 أيام',
