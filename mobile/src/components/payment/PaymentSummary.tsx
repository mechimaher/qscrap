...
export const PaymentSummary: React.FC<PaymentSummaryProps> = ({
    ...
    return (
        <LinearGradient colors={['#1a1a2e', '#2d2d44']} style={styles.vvipOrderCard}>
            ...
            <View style={[styles.vvipPriceRow, { flexDirection: rtlFlexDirection(isRTL) }]}>
                ...
                <Text style={styles.vvipPriceValue}>
                    {partPrice.toFixed(0)} {t('common.currency')}
                </Text>
            </View>
            <View style={[styles.vvipPriceRow, { flexDirection: rtlFlexDirection(isRTL) }]}>
                <Text style={styles.vvipPriceLabel}>{t('order.deliveryFee')}</Text>
                <Text style={styles.vvipPriceValue}>
                    {deliveryFee.toFixed(0)} {t('common.currency')}
                </Text>
            </View>
            <View style={[styles.vvipPriceRow, { marginTop: Spacing.sm, flexDirection: rtlFlexDirection(isRTL) }]}>
                ...
                <Text style={styles.vvipTotalValue}>
                    {totalAmount.toFixed(0)} {t('common.currency')}
                </Text>
            </View>
        </LinearGradient>
    );
