 ...
 */
export const ViewerBadge: React.FC<ViewerBadgeProps> = ({ viewerCount, showAnimation = true, size = 'medium' }) => {
    ...
    return (
        <Animated.View style={[styles.container, currentSize.container, { transform: [{ scale: scaleValue }] }]}>
            ...
            <Text style={currentSize.text}>
                {displayCount === 1
                    ? t('viewerBadge.garageViewing', { count: displayCount })
                    : t('viewerBadge.garagesViewing', { count: displayCount })}
            </Text>
        </Animated.View>
    );
};
 ...
 */
export const ViewerBadgeCompact: React.FC<ViewerBadgeProps> = ({ viewerCount }) => {
    if (viewerCount === 0) return null;
 ...
 */
export const ViewerBadgeLive: React.FC<ViewerBadgeProps & { isLive?: boolean }> = ({ viewerCount, isLive = true }) => {
    const { t } = useTranslation();
    ...
    return (
        <View style={styles.liveContainer}>
            ...
            <Text style={styles.liveText}>
                {viewerCount === 1
                    ? t('viewerBadge.garageViewing', { count: viewerCount })
                    : t('viewerBadge.garagesViewing', { count: viewerCount })}
            </Text>
        </View>
    );
};
