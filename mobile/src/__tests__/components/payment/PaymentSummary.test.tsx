...
describe('PaymentSummary', () => {
    ...
    it('should handle long part descriptions with truncation', () => {
        const longDescription =
            'This is a very long part description that should be truncated properly in the UI to prevent layout issues';
    ...
    it('should handle zero prices', () => {
        ...
        expect(screen.getAllByText('0 QAR').length).toBeGreaterThan(0);
    });
