...
export const en = {
    ...
    auth: {
        ...
        // Forgot Password - Enterprise Flow
        ...
        forgotPasswordMessage: 'To reset your password, please check your email for the OTP code or contact support.',
        resetViaEmail: 'Send Email',
        contactSupport: 'Call Support',
        networkError: 'Network error. Please check your connection.',
        // OTP Verification (uses existing keys from registration OTP)
        ...
        passwordNeedsUppercase: 'Password needs at least one uppercase letter',
        passwordNeedsLowercase: 'Password needs at least one lowercase letter',
        passwordNeedsNumber: 'Password needs at least one number',
    ...
    order: {
        ...
        cancelOrder: 'Cancel Order',
        deliveryOtpTitle: 'Delivery OTP',
        otpInstruction: 'Show this 4-digit code only when the driver is at your door.',
        ...
        escrowExpiresNow: 'Escrow releasing now',
        escrowExpiresFallback: 'Funds release after the inspection window',
        freezeFunds: 'Report issue & freeze',
    ...
    tracking: {
        ...
        view: 'View',
        secureOtp: 'Secure handoff code',
        otpInstruction: 'Only share this code with the QScrap driver at your doorstep.',
    ...
    payment: {
        ...
        securedByStripePlatform: 'Secured by Stripe • Apple Pay / Google Pay',
        applePayExpress: 'Pay instantly with Apple Pay',
        googlePayExpress: 'Pay instantly with Google Pay',
