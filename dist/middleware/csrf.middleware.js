...
exports.strictValidateOrigin = exports.validateOrigin = void 0;
/**
...
const isValidOrigin = (origin, referer) => {
 ...
 */
const strictValidateOrigin = (req, res, next) => {
    const safeMethods = ['GET', 'HEAD', 'OPTIONS'];
    if (safeMethods.includes(req.method)) {
        return next();
    }
...
exports.strictValidateOrigin = strictValidateOrigin;
