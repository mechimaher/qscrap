...
exports.getReturnStats = exports.assignDriverToReturn = exports.getPendingReturns = exports.getGarages = exports.getUserStats = exports.activateUser = exports.suspendUser = exports.getUserDetails = exports.getQualityStats = exports.getAnalytics = exports.getDisputeDetails = exports.getUsers = exports.resolveDispute = exports.getDisputes = exports.collectOrder = exports.updateOrderStatus = exports.getOrderDetails = exports.getOrders = exports.getDashboardStats = void 0;
...
const getOrderDetails = async (req, res) => {
    ...
    try {
        ...
        // Get status history
        const historyResult = await db_1.default.query(`
...
const updateOrderStatus = async (req, res) => {
    ...
    try {
        ...
        const orderResult = await client.query(`SELECT o.order_status, o.customer_id, o.garage_id, o.order_number, 
                    o.part_price, o.platform_fee, o.garage_payout_amount, o.driver_id
             FROM orders o WHERE o.order_id = $1`, [order_id]);
        if (orderResult.rows.length === 0) {
        ...
        // Record in history
        await client.query(`INSERT INTO order_status_history (order_id, old_status, new_status, changed_by, reason, changed_by_type)
             VALUES ($1, $2, $3, $4, $5, 'operations')`, [order_id, oldStatus, new_status, staffId, notes || 'Manually updated by Operations']);
...
const collectOrder = async (req, res) => {
    ...
    try {
        ...
        const orderResult = await client.query(`SELECT order_status, customer_id, garage_id, order_number 
             FROM orders WHERE order_id = $1 FOR UPDATE`, [order_id]);
        if (orderResult.rows.length === 0) {
            throw new Error('Order not found');
        }
        const order = orderResult.rows[0];
        ...
        await client.query(`UPDATE orders SET order_status = 'collected', updated_at = NOW() WHERE order_id = $1`, [order_id]);
        // Record in history
        await client.query(`INSERT INTO order_status_history (order_id, old_status, new_status, changed_by, changed_by_type, reason)
             VALUES ($1, $2, $3, $4, 'operations', $5)`, [order_id, 'ready_for_pickup', 'collected', staffId, notes || 'Order collected from garage']);
        await client.query('COMMIT');
        // Notify customer and garage
        const io = global.io;
        io.to(`user_${order.customer_id}`).emit('order_status_updated', {
...
const resolveDispute = async (req, res) => {
    ...
    try {
        await client.query('BEGIN');
        const disputeResult = await client.query(`SELECT d.*, o.order_number, o.customer_id, o.garage_id, o.order_id,
             ...
             JOIN users u ON o.customer_id = u.user_id
             JOIN part_requests pr ON o.request_id = pr.request_id
             WHERE d.dispute_id = $1`, [dispute_id]);
        ...
        await client.query(`UPDATE disputes 
             SET status = 'resolved',
                 ...
                 resolved_at = NOW()
             WHERE dispute_id = $1`, [dispute_id, resolution, finalRefundAmount]);
        ...
        await client.query(`UPDATE orders SET order_status = $1, updated_at = NOW() WHERE order_id = $2`, [newOrderStatus, dispute.order_id]);
        // Record in status history
        await client.query(`INSERT INTO order_status_history (order_id, old_status, new_status, changed_by, changed_by_type, reason)
             VALUES ($1, 'disputed', $2, $3, 'operations', $4)`, [dispute.order_id, newOrderStatus, staffId, notes || `Dispute resolved: ${resolution}`]);
        // =================================================================
...
const getAnalytics = async (req, res) => {
    ...
    try {
        ...
        const ordersResult = await db_1.default.query(`
            SELECT 
        ...
        const ordersByDayResult = await db_1.default.query(`
        ...
        const disputesResult = await db_1.default.query(`
            SELECT 
        ...
        const topGaragesResult = await db_1.default.query(`
        ...
        const topPartsResult = await db_1.default.query(`
...
const getQualityStats = async (req, res) => {
    try {
        ...
        const rateResult = await db_1.default.query(`
            SELECT 
        ...
        const recentResult = await db_1.default.query(`
            SELECT o.order_id, o.order_number, o.order_status, o.updated_at,
                   pr.part_description,
...
const getUserDetails = async (req, res) => {
    ...
    try {
        ...
        const ordersResult = ordersQuery
            ? await db_1.default.query(ordersQuery, [user_id])
            : { rows: [] };
        // Get disputes
        const disputesResult = await db_1.default.query(`
...
const assignDriverToReturn = async (req, res) => {
    ...
    try {
        ...
        const driverResult = await client.query('SELECT driver_id, full_name, status FROM drivers WHERE driver_id = $1', [driver_id]);
...
exports.assignDriverToReturn = assignDriverToReturn;
