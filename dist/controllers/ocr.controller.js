...
exports.recognizeVIN = recognizeVIN;
 ...
 */
async function recognizeVIN(req, res) {
    try {
 ...
 */
function applyVINCorrections(vin) {
    ...
    if (chars[0] === 'J' && chars[1] === 'N' && /[A-Z]/.test(chars[5])) {
        if (chars[5] === 'I' || chars[5] === 'L' || chars[5] === '1')
            chars[5] = '2';
        if (chars[5] === 'Z')
            chars[5] = '2';
        if (chars[5] === 'S')
        ...
        if (chars[5] === 'B')
            chars[5] = '8';
        if (chars[5] === 'O' || chars[5] === 'D' || chars[5] === 'Q')
            chars[5] = '0';
    }
    // Position 9: Check digit (must be 0-9 or X)
    if (!/[0-9X]/.test(chars[8])) {
        if (chars[8] === 'O' || chars[8] === 'D' || chars[8] === 'Q')
            chars[8] = '0';
        if (chars[8] === 'I' || chars[8] === 'L')
            chars[8] = '1';
        if (chars[8] === 'S')
            chars[8] = '5';
        if (chars[8] === 'B' || chars[8] === 'R')
            chars[8] = '8';
        if (chars[8] === 'Z')
            chars[8] = '2';
    }
    ...
    for (let i = 11; i < 17; i++) {
        if (/[A-Z]/.test(chars[i])) {
            if (chars[i] === 'O' || chars[i] === 'D' || chars[i] === 'Q')
                chars[i] = '0';
