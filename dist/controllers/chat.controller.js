...
exports.sendOrderChatMessage = exports.getOrderChatMessages = exports.getUnreadCount = exports.sendChatMessage = exports.getChatMessages = void 0;
...
const getChatMessages = async (req, res) => {
    ...
    try {
        ...
        const accessCheck = await db_1.default.query(`
        ...
        // Get messages
        const messages = await db_1.default.query(`
 ...
 */
const getOrderChatMessages = async (req, res) => {
    const { order_id } = req.params;
    const userId = req.user.userId;
    try {
        // Get assignment for this order
        const assignmentResult = await db_1.default.query(`
...
exports.getOrderChatMessages = getOrderChatMessages;
/**
...
exports.sendOrderChatMessage = sendOrderChatMessage;
