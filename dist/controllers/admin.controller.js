...
exports.adminCreateUser = exports.adminResetPassword = exports.adminActivateUser = exports.adminSuspendUser = exports.updateUserAdmin = exports.getAdminUserDetails = exports.getAllUsers = exports.updateGarageSpecializationAdmin = exports.overrideCommission = exports.extendSubscription = exports.revokeSubscription = exports.assignPlanToGarage = exports.getSubscriptionPlans = exports.getAuditLog = exports.getAdminDashboardStats = exports.revokeGarageAccess = exports.grantDemoAccess = exports.rejectGarage = exports.approveGarage = exports.getAllGaragesAdmin = exports.getPendingGarages = void 0;
...
const getPendingGarages = async (req, res) => {
    ...
    try {
        ...
        // Get total count
        const countResult = await db_1.default.query(`SELECT COUNT(*) FROM garages g JOIN users u ON g.garage_id = u.user_id ${whereClause}`, params);
 ...
 */
const getAllGaragesAdmin = async (req, res) => {
...
exports.getAllGaragesAdmin = getAllGaragesAdmin;
/**
 * Approve a garage
 */
...
exports.grantDemoAccess = grantDemoAccess;
/**
 * Revoke garage access (suspend approved/demo garage)
 */
const revokeGarageAccess = async (req, res) => {
    const { garage_id } = req.params;
    const { reason } = req.body;
    const adminId = req.user?.userId;
    try {
        ...
        try {
            ...
            const currentStatus = await client.query(`SELECT approval_status FROM garages WHERE garage_id = $1`, [garage_id]);
            // Update garage
            const result = await client.query(`
                UPDATE garages SET
...
exports.revokeGarageAccess = revokeGarageAccess;
// ============================================================================
...
const getAuditLog = async (req, res) => {
    ...
    try {
        ...
        // Get total count
        const countResult = await db_1.default.query(`SELECT COUNT(*) FROM admin_audit_log al ${whereClause}`, params);
        const total = parseInt(countResult.rows[0].count);
        const result = await db_1.default.query(`
            SELECT 
                al.*,
 ...
 */
const assignPlanToGarage = async (req, res) => {
    const { garage_id } = req.params;
...
exports.assignPlanToGarage = assignPlanToGarage;
/**
 ...
 */
const overrideCommission = async (req, res) => {
    const { garage_id } = req.params;
...
const updateGarageSpecializationAdmin = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            const currentResult = await client.query(`SELECT supplier_type, specialized_brands, all_brands FROM garages WHERE garage_id = $1`, [garage_id]);
...
exports.updateGarageSpecializationAdmin = updateGarageSpecializationAdmin;
// ============================================================================
...
const getAllUsers = async (req, res) => {
    ...
    try {
        ...
        // Count
        const countResult = await db_1.default.query(`SELECT COUNT(*) FROM users ${whereClause}`, params);
        const total = parseInt(countResult.rows[0].count);
        // Get users
        const result = await db_1.default.query(`
            SELECT 
...
const getAdminUserDetails = async (req, res) => {
    ...
    try {
        ...
        if (user.user_type === 'customer') {
            const orders = await db_1.default.query(`
            ...
            const garage = await db_1.default.query(`
                SELECT g.*, 
                       (SELECT COUNT(*) FROM orders WHERE garage_id = g.garage_id) as total_orders,
                       (SELECT COUNT(*) FROM bids WHERE garage_id = g.garage_id) as total_bids
            ...
            const driver = await db_1.default.query(`
        ...
        // Get recent activity
        const activity = await db_1.default.query(`
...
const updateUserAdmin = async (req, res) => {
    ...
    try {
        ...
        try {
            await client.query('BEGIN');
            // Get current values
            const current = await client.query(`SELECT full_name, email, phone_number FROM users WHERE user_id = $1`, [user_id]);
...
exports.adminActivateUser = adminActivateUser;
/**
...
const adminCreateUser = async (req, res) => {
    const adminId = req.user?.userId;
    const { phone_number, password, full_name, email, user_type, is_active = true, garage_data, driver_data, staff_data } = req.body;
    // Validation
    ...
    try {
        ...
        try {
            ...
            const existingUser = await client.query(`SELECT user_id FROM users WHERE phone_number = $1`, [phone_number]);
