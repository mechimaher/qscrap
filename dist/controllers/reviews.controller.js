...
exports.moderateReview = exports.getAllReviews = exports.getPendingReviews = exports.getMyReviews = exports.getGarageReviews = void 0;
...
const getGarageReviews = async (req, res) => {
    ...
    try {
        ...
        const reviewsResult = await db_1.default.query(`
            SELECT 
                r.review_id,
                r.overall_rating,
