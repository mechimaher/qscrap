...
exports.getAvailableReports = exports.getRegistrationsReport = exports.getAllGaragesReport = exports.getCommissionRevenueReport = exports.getSubscriptionRenewalsReport = exports.getDemoConversionsReport = exports.getExpiredDemosReport = exports.getDemoGaragesReport = void 0;
 ...
 */
const getDemoGaragesReport = async (req, res) => {
...
exports.getDemoGaragesReport = getDemoGaragesReport;
/**
 * Report: Expired Demo Garages
 * Lists garages whose demo has expired for follow-up
 */
const getExpiredDemosReport = async (req, res) => {
...
const getDemoConversionsReport = async (req, res) => {
    ...
    try {
        ...
        const demoCount = await db_1.default.query(`
...
exports.getDemoConversionsReport = getDemoConversionsReport;
// ============================================================================
 ...
 */
const getSubscriptionRenewalsReport = async (req, res) => {
...
exports.getSubscriptionRenewalsReport = getSubscriptionRenewalsReport;
/**
 * Report: Commission Revenue
 * Platform earnings from completed orders
 */
const getCommissionRevenueReport = async (req, res) => {
    ...
    try {
        ...
        const breakdown = await db_1.default.query(`
            SELECT 
        ...
        `, [start, end]);
        // Top earning garages
        const topGarages = await db_1.default.query(`
            SELECT 
                g.garage_name,
                COUNT(*) as order_count,
...
exports.getCommissionRevenueReport = getCommissionRevenueReport;
/**
 * Report: All Garages Summary
 * Comprehensive garage listing with all statuses
 */
const getAllGaragesReport = async (req, res) => {
    ...
    try {
        ...
        const countResult = await db_1.default.query(`SELECT COUNT(*) FROM garages g ${whereClause}`, params);
        const total = parseInt(countResult.rows[0].count);
        const result = await db_1.default.query(`
            SELECT 
                g.garage_id,
...
exports.getAllGaragesReport = getAllGaragesReport;
/**
 * Report: New Registrations
 * User registration activity over time
 */
const getRegistrationsReport = async (req, res) => {
    ...
    try {
        ...
        `, [start, end]);
        // Daily breakdown
        const daily = await db_1.default.query(`
            SELECT 
...
exports.getRegistrationsReport = getRegistrationsReport;
/**
