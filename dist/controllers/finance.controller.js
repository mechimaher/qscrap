...
exports.getPaymentStats = exports.autoConfirmPayouts = exports.resolvePaymentDispute = exports.getAwaitingConfirmation = exports.disputePayment = exports.confirmPayment = exports.sendPayment = exports.getPayoutConfig = exports.getPayoutStatus = exports.releasePayout = exports.forceProcessPayout = exports.getTransactions = exports.getRevenueReport = exports.createRefund = exports.getTransactionDetails = exports.holdPayout = exports.processPayout = exports.getPayouts = exports.getPayoutSummary = void 0;
...
const getPayoutSummary = async (req, res) => {
    ...
    try {
        ...
        if (userType === 'garage') {
            ...
            const revRes = await db_1.default.query(`
...
const getPayouts = async (req, res) => {
    ...
    try {
        ...
        const countResult = await db_1.default.query(`SELECT COUNT(*) FROM garage_payouts gp ${whereClause}`, params);
        res.json({
            payouts: result.rows,
...
// Hold a payout
const holdPayout = async (req, res) => {
    const { payout_id } = req.params;
...
const getTransactionDetails = async (req, res) => {
    ...
    try {
        ...
        const payoutResult = await db_1.default.query('SELECT * FROM garage_payouts WHERE order_id = $1', [order_id]);
        // Get refunds for this order
        const refundResult = await db_1.default.query('SELECT * FROM refunds WHERE order_id = $1', [order_id]);
        res.json({
...
const createRefund = async (req, res) => {
    ...
    try {
        ...
        const orderResult = await client.query('SELECT total_amount, garage_payout_amount, garage_id, order_number FROM orders WHERE order_id = $1', [order_id]);
        if (orderResult.rows.length === 0) {
        ...
        const { reversePayout } = await Promise.resolve().then(() => __importStar(require('../services/payout.service')));
...
const getRevenueReport = async (req, res) => {
    ...
    try {
        let garageId = null;
        const params = [daysBack]; // $1 = days interval
        let paramIndex = 2;
        if (userType === 'garage') {
            // For garage users, userId IS the garage_id
            garageId = userId;
        ...
        const dailyResult = await db_1.default.query(`
            SELECT 
...
const getTransactions = async (req, res) => {
    ...
    try {
        ...
        const countResult = await db_1.default.query(countQuery, userType === 'garage' ? [userId] : []);
...
const forceProcessPayout = async (req, res) => {
    const { payout_id } = req.params;
...
const getPayoutConfig = async (_req, res) => {
...
exports.getPayoutConfig = getPayoutConfig;
// ============================================
 ...
 */
const getAwaitingConfirmation = async (req, res) => {
    const garageId = req.user.userId;
    try {
...
exports.getAwaitingConfirmation = getAwaitingConfirmation;
/**
    ...
    try {
        ...
        let updateQuery = `
            UPDATE garage_payouts SET
                ...
                resolved_by = $3,
                resolved_at = NOW()`;
        const queryParams = [newStatus, updateNotes, req.user?.userId];
        let paramIndex = 4;
...
exports.resolvePaymentDispute = resolvePaymentDispute;
/**
 * CRON JOB: Auto-confirm payouts after deadline
 * Call this from scheduler every hour
 */
const autoConfirmPayouts = async () => {
    try {
...
exports.autoConfirmPayouts = autoConfirmPayouts;
/**
