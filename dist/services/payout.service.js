...
exports.getPayoutByOrderId = getPayoutByOrderId;
exports.canProcessPayout = canProcessPayout;
 ...
 */
async function createPayout(orderId) {
    try {
 ...
 */
async function reversePayout(orderId, refundAmount) {
    ...
    try {
        ...
        if (isFullRefund) {
            ...
            // Notify garage
            try {
                global.io?.to(`garage_${payout.garage_id}`).emit('payout_cancelled', {
            ...
            // Notify garage
            try {
                global.io?.to(`garage_${payout.garage_id}`).emit('payout_adjusted', {
                    payout_id: payout.payout_id,
                    order_id: orderId,
 ...
 */
async function getPayoutByOrderId(orderId) {
    try {
        const result = await db_1.default.query(`
 ...
 */
async function canProcessPayout(orderId) {
    try {
        ...
        const refundResult = await db_1.default.query(`
