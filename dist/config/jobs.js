...
exports.expireCounterOffers = expireCounterOffers;
exports.checkSubscriptions = checkSubscriptions;
exports.autoResolveDisputes = autoResolveDisputes;
exports.schedulePendingPayouts = schedulePendingPayouts;
exports.autoProcessPayouts = autoProcessPayouts;
exports.cleanupOldData = cleanupOldData;
exports.autoConfirmDeliveries = autoConfirmDeliveries;
exports.autoConfirmPayouts = autoConfirmPayouts;
exports.abandonStaleInspections = abandonStaleInspections;
...
// ============================================
async function expireCounterOffers() {
    try {
...
// ============================================
async function schedulePendingPayouts() {
    try {
...
// ============================================
async function autoProcessPayouts() {
    const client = await db_1.default.connect();
    try {
        await client.query('BEGIN');
...
async function cleanupOldData() {
    try {
        ...
        const notifResult = await db_1.default.query(`
...
// ============================================
async function autoConfirmPayouts() {
    try {
        const result = await db_1.default.query(`
...
// ============================================
async function abandonStaleInspections() {
    try {
        const result = await db_1.default.query(`
