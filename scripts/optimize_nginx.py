...
# Optimized Nginx config with better buffering and timeout settings
nginx_config = """
server {
    listen 80;
    listen [::]:80;
...
try:
    ...
    print("📝 Applying optimized Nginx config (no buffering)...")
    ...
    if 'ok' in err or 'successful' in err:
        print("✅ Nginx reloaded with optimized settings")
    else:
        print(err)
    ...
    client.close()
    print("\n🔗 Please test: https://qscrap.qa/verify/QS-VRF-8DKE557K")
