...
const legalTranslations = {
    ...
    ar: {
        ...
        // Section 1
        'refund.s1.title': 'ضمان الإرجاع خلال ٧ أيام',
        'refund.s1.intro': 'جميع القطع المشتراة عبر كيوسكراب تأتي مع ضمان إرجاع لمدة ٧ أيام من تاريخ التسليم:',
        ...
        'refund.s1.highlight': '<strong>استرداد كامل مضمون</strong> خلال ٧ أيام إذا كانت القطعة لا تتطابق مع الوصف أو كانت معيبة.',
        ...
        'refund.s3.item3': 'القطع المرجعة بعد فترة الإرجاع ٧ أيام',
        ...
        'refund.s4.item5': 'سيراجع فريق الدعم خلال ٢٤ ساعة',
        ...
        'refund.s5.item1': '<strong>الدفع بالبطاقة:</strong> ٥-٧ أيام عمل بعد الموافقة',
        'refund.s5.item2': '<strong>الدفع عند الاستلام:</strong> تحويل بنكي خلال ٣-٥ أيام عمل',
        ...
        'refund.s6.item2': 'سيراجع فريق الدعم الأقدم خلال ٤٨ ساعة',
        ...
        'refund.s6.rights': '<strong>حقوق المستهلك:</strong> لا شيء في هذه السياسة يؤثر على حقوقك القانونية بموجب قانون حماية المستهلك القطري (القانون رقم ٨ لسنة ٢٠٠٨) ولوائح وزارة التجارة والصناعة.',
        ...
        'refund.contact.cr': 'السجل التجاري: ١٥٥٨٩٢ | دولة قطر',
        ...
        'terms.s3.item1': 'أن يكون عمرك ١٨ عاماً على الأقل أو العمر القانوني في ولايتك القضائية',
        ...
        'terms.s5.item2': 'تتراوح فترات الضمان من ٧ إلى ٣٠ يوماً حسب حالة القطعة',
        'terms.s5.item3': 'القطع الجديدة: ضمان ٣٠ يوماً',
        'terms.s5.item4': 'القطع المستعملة (ممتازة/جيدة): ضمان ١٤ يوماً',
        'terms.s5.item5': 'القطع المستعملة (مقبولة): ضمان ٧ أيام',
        ...
        'terms.s7.rights': '<strong>حقوق المستهلك:</strong> لا شيء في هذه الشروط يؤثر على حقوقك القانونية بموجب قانون حماية المستهلك القطري (القانون رقم ٨ لسنة ٢٠٠٨).',
        ...
        'privacy.s1.intro': 'نجمع أنواع المعلومات التالية:',
        'privacy.s1.h1': '📱 معلومات الحساب',
        'privacy.s1.h1.items': 'الاسم الكامل، البريد الإلكتروني، رقم الهاتف، وصورة الملف الشخصي',
        'privacy.s1.h2': '🚗 معلومات السيارة',
        'privacy.s1.h2.items': 'الشركة المصنعة، الموديل، السنة، رقم الهيكل، وتفاصيل التسجيل',
        'privacy.s1.h3': '📍 بيانات الموقع',
        'privacy.s1.h3.items': 'عناوين التوصيل والموقع الفوري للتوصيلات',
        'privacy.s1.h4': '💳 معلومات الدفع',
        'privacy.s1.h4.items': 'تفاصيل طريقة الدفع (تتم معالجتها بأمان من شركائنا في الدفع)',

        'privacy.s2.title': 'كيف نستخدم معلوماتك',
        'privacy.s2.intro': 'نستخدم معلوماتك من أجل:',
        'privacy.s2.item1': 'معالجة وتنفيذ طلبات قطع الغيار',
        'privacy.s2.item2': 'ربطك بالكراجات والسائقين المعتمدين',
        'privacy.s2.item3': 'توفير تتبع التوصيل الفوري',
        'privacy.s2.item4': 'معالجة المدفوعات والاستردادات بأمان',
        'privacy.s2.item5': 'إرسال تحديثات الطلبات والإشعارات المهمة',
        'privacy.s2.item6': 'تحسين خدماتنا وتجربة المستخدم',
        'privacy.s2.item7': 'الامتثال للالتزامات القانونية',

        'privacy.s3.title': 'مشاركة البيانات',
        'privacy.s3.intro': 'نشارك معلوماتك فقط مع:',
        'privacy.s3.item1': '<strong>الكراجات:</strong> لتنفيذ طلبات القطع (محدودة بالتفاصيل الضرورية)',
        'privacy.s3.item2': '<strong>سائقي التوصيل:</strong> لتوصيل طلباتك (العنوان ومعلومات الاتصال فقط)',
        'privacy.s3.item3': '<strong>معالجي الدفع:</strong> لمعالجة معاملاتك بأمان',
        'privacy.s3.item4': '<strong>السلطات القانونية:</strong> عند الاقتضاء بموجب قانون قطر',
        'privacy.s3.note': '<strong>نحن لا نبيع بياناتك الشخصية لأطراف ثالثة أبداً.</strong>',

        'privacy.s4.title': 'أمان البيانات',
        'privacy.s4.intro': 'نحمي بياناتك بـ:',
        'privacy.s4.item1': 'تشفير SSL/TLS لجميع عمليات نقل البيانات',
        'privacy.s4.item2': 'تخزين مشفر للمعلومات الحساسة',
        'privacy.s4.item3': 'عمليات تدقيق وتحديثات أمنية منتظمة',
        'privacy.s4.item4': 'ضوابط وصول صارمة لفريقنا',
        'privacy.s4.item5': 'مراكز بيانات آمنة متوافقة مع لوائح قطر',

        'privacy.s5.title': 'حقوقك',
        'privacy.s5.intro': 'بموجب قانون حماية البيانات الشخصية القطري، لديك الحق في:',
        'privacy.s5.item1': '<strong>الوصول:</strong> طلب نسخة من بياناتك الشخصية',
        'privacy.s5.item2': '<strong>التصحيح:</strong> تصحيح المعلومات غير الدقيقة',
        'privacy.s5.item3': '<strong>المحو:</strong> طلب حذف بياناتك (مع بعض الاستثناءات)',
        'privacy.s5.item4': '<strong>قابلية النقل:</strong> استلام بياناتك بتنسيق محمول',
        'privacy.s5.item5': '<strong>الاعتراض:</strong> الاعتراض على أنشطة معالجة معينة',
        'privacy.s5.contact': 'لممارسة أي من هذه الحقوق، تواصل معنا على <a href="mailto:privacy@qscrap.qa">privacy@qscrap.qa</a>',

        'privacy.s6.title': 'الاحتفاظ بالبيانات',
        'privacy.s6.p1': 'نحتفظ ببياناتك طالما حسابك نشط أو حسب الحاجة لتقديم الخدمات. يتم الاحتفاظ بسجلات المعاملات لمدة ٧ سنوات كما يتطلب القانون التجاري القطري.',
        'privacy.s6.p2': 'عند حذف حسابك، سنزيل بياناتك الشخصية خلال ٣٠ يوماً، إلا حيث يكون الاحتفاظ مطلوباً بموجب القانون.',

        'privacy.s7.title': 'ملفات تعريف الارتباط والتتبع',
        'privacy.s7.p1': 'تستخدم تطبيقاتنا المحمولة تتبعاً بسيطاً للوظائف الأساسية:',
        'privacy.s7.item1': 'إدارة الجلسات',
        'privacy.s7.item2': 'الإبلاغ عن الأعطال ومراقبة الأداء',
        'privacy.s7.item3': 'تسليم الإشعارات الفورية',
        'privacy.s7.p2': 'نحن لا نستخدم متتبعات إعلانية من طرف ثالث.',

        'privacy.s8.title': 'التغييرات على هذه السياسة',
        'privacy.s8.p1': 'قد نحدث هذه السياسة من وقت لآخر. سنخطرك بالتغييرات المهمة عبر البريد الإلكتروني أو إشعار التطبيق.',
        'privacy.s8.p2': 'استمرار استخدام كيوسكراب بعد التغييرات يشكل قبولاً للسياسة المحدثة.',
