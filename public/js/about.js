...
const translations = {
    ...
    ar: {
        ...
        'mission.p2': 'منصتنا تتولى كل شيء من البحث إلى التوصيل، مع تجربة سلسة مدعومة بأقوى حماية للمستهلك في قطر بما في ذلك <strong>ضمان إرجاع ٧ أيام</strong> ومدفوعات ضمان آمنة.',
        'mission.p3': 'سواء كنت بحاجة إلى قطعة OEM نادرة أو بديل قياسي، كيوسكراب يربطك بالكراج المناسب في دقائق وليس أيام.',
        ...
        'footer.copyright': '© ٢٠٢٦ كيوسكراب. جميع الحقوق محفوظة.'
    }
};
