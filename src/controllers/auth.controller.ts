...
export const register = catchAsync(async (req: Request, res: Response) => {
    const { phone_number, password, user_type, full_name, email, garage_name, address, supplier_type, specialized_brands, all_brands, location_lat, location_lng, preferred_plan_code } = req.body;
    ...
    const result = await authService.registerUser({ phone_number, password, user_type, full_name, email, garage_name, address, supplier_type, specialized_brands, all_brands, location_lat: validLat, location_lng: validLng, preferred_plan_code });
