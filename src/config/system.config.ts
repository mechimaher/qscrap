...
export const SystemConfig = {
    ...
    // DELIVERY FEES
    // ============================================
    DEFAULT_DELIVERY_FEE: 25.0, // QAR
    FREE_DELIVERY_THRESHOLD: 500.0, // QAR - orders above this get free delivery
    ...
    DEMO_COMMISSION_RATE: 0.0, // 0% for demo garages
    CANCELLATION_FEE_PREPARING: 0.1, // 10% fee if cancelled during preparing
