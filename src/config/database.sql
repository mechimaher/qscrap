...
\restrict maNbb4cRmX75PoQvHjvmgCK5MvqgOCGww6yyZTOuF2AWP2T6A3Wp7unyE1vPTYs
...
CREATE TABLE public.garage_payouts (
    ...
    CONSTRAINT garage_payouts_payout_status_check CHECK (((payout_status)::text = ANY ((ARRAY['pending'::character varying, 'processing'::character varying, 'awaiting_confirmation'::character varying, 'completed'::character varying, 'disputed'::character varying, 'failed'::character varying, 'on_hold'::character varying])::text[])))
);
...
CREATE TABLE public.part_requests (
    ...
    delivery_lat numeric(10,8),
    delivery_lng numeric(11,8),
    CONSTRAINT part_requests_car_year_check CHECK (((car_year >= 1900) AND (car_year <= 2030))),
...
\unrestrict maNbb4cRmX75PoQvHjvmgCK5MvqgOCGww6yyZTOuF2AWP2T6A3Wp7unyE1vPTYs
