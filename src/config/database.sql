...
-- Manually populate migrations table to satisfy migrate.js
INSERT INTO public.migrations (name, checksum, applied_at) VALUES
('20241212_enhanced_qc.sql', NULL, NOW()),
('20241212_qc_delivery_flow.sql', NULL, NOW()),
('20241213_comprehensive_audit.sql', NULL, NOW()),
('20241213_support_chat.sql', NULL, NOW()),
('20241216_documents_module.sql', NULL, NOW()),
('20241216_payout_confirmation.sql', NULL, NOW()),
('20241217_fix_delivery_assignments.sql', NULL, NOW()),
('20241217_fix_missing_columns.sql', NULL, NOW()),
('20241217_review_moderation.sql', NULL, NOW()),
('20241219_delivery_location.sql', NULL, NOW()),
('20241219_driver_payouts_chat.sql', NULL, NOW()),
('20241220_driver_reassignment.sql', NULL, NOW()),
('20241222_refunds_columns.sql', NULL, NOW()),
('20241223_admin_module.sql', NULL, NOW()),
('20241224_delivery_zones.sql', NULL, NOW()),
('20241224_demo_bid_fix.sql', NULL, NOW()),
('20241224_performance_indexes.sql', NULL, NOW()),
('20241227_staff_profiles.sql', NULL, NOW()),
('20241228_fix_payout_status_length.sql', NULL, NOW()),
('20241229_garage_specialization.sql', NULL, NOW()),
('20241229_indexes_constraints_cleanup.sql', NULL, NOW()),
('20241229_payout_adjustments.sql', NULL, NOW()),
('20241229_support_ticket_sla.sql', NULL, NOW()),
('20241231_cleanup_duplicates.sql', NULL, NOW()),
('20241231_parts_showcase.sql', NULL, NOW()),
('20251224_address_module.sql', NULL, NOW()),
('20251226_user_settings.sql', NULL, NOW()),
('20251231_add_original_bid_amount.sql', NULL, NOW()),
('20260108_driver_locations.sql', NULL, NOW()),
('20260111_add_driver_bank_details.sql', NULL, NOW()),
('20260111_add_part_category.sql', NULL, NOW()),
('20260113_add_resolved_by_to_payouts.sql', NULL, NOW()),
('20260113_create_driver_wallets.sql', NULL, NOW()),
('20260114_customer_vehicles.sql', NULL, NOW()),
('20260115_performance_indexes_scale.sql', NULL, NOW()),
('20260115_service_expansion.sql', NULL, NOW()),
('20260116_ad_marketplace.sql', NULL, NOW()),
('20260116_customer_loyalty.sql', NULL, NOW()),
('20260116_garage_analytics.sql', NULL, NOW()),
('20260116_performance_optimization.sql', NULL, NOW()),
('20260116_price_benchmarking.sql', NULL, NOW()),
('20260116_subscription_tiers.sql', NULL, NOW()),
('20260116_unified_partner_model.sql', NULL, NOW()),
('20260118_certified_schema_optimization.sql', NULL, NOW()),
('20260118_escrow_system.sql', NULL, NOW()),
('20260118_loyalty_functions.sql', NULL, NOW()),
('20260118_payment_system.sql', NULL, NOW()),
('20260118_schema_optimization.sql', NULL, NOW()),
('20260119_remove_services.sql', NULL, NOW()),
('20260119_vehicle_id_photos.sql', NULL, NOW()),
('20260120_vin_capture.sql', NULL, NOW()),
('20260122_delivery_fee_tiers.sql', NULL, NOW()),
('20260122_drop_insurance_tables.sql', NULL, NOW()),
('20260122_fix_dispute_status.sql', NULL, NOW()),
('20260122_fix_payout_cancellation_columns.sql', NULL, NOW()),
('20260122_fix_payout_type_column.sql', NULL, NOW()),
('20260122_fix_refunds_initiated_by.sql', NULL, NOW()),
('20260122_remove_insurance_services.sql', NULL, NOW()),
('20260123_payout_reversals.sql', NULL, NOW()),
('20260123_ticket_escalation.sql', NULL, NOW()),
('20260124_add_payment_tables.sql', NULL, NOW()),
('20260126_support_actions_tables.sql', NULL, NOW()),
('20260126_support_phase3_enhancements.sql', NULL, NOW()),
('20260127_add_resolution_action_column.sql', NULL, NOW()),
('20260127_add_ticket_id_to_escalations.sql', NULL, NOW()),
('20260127_comprehensive_constraint_audit.sql', NULL, NOW()),
('20260127_fix_order_status_history_constraint.sql', NULL, NOW()),
('20260127_fix_refunds_schema_alignment.sql', NULL, NOW()),
('20260127_support_audit_fixes.sql', NULL, NOW()),
('20260128_add_customer_notes_resolution_logs.sql', NULL, NOW()),
('20260128_cancellation_compliance.sql', NULL, NOW()),
('20260128_drop_legacy_reviews_table.sql', NULL, NOW()),
('20260129_complete_refunds_schema.sql', NULL, NOW()),
('20260129b_fix_refunds_data.sql', NULL, NOW()),
('20260130_refund_system_hardening.sql', NULL, NOW()),
('20260202_auto_demo_registration.sql', NULL, NOW()),
('20260202_enterprise_infrastructure.sql', NULL, NOW()),
('20260202_moci_delivery_fee_compliance.sql', NULL, NOW()),
('20260202_subscription_upgrade_payments.sql', NULL, NOW()),
('20260203_add_cancelled_to_request_status.sql', NULL, NOW()),
('20260208_commission_rate_check.sql', NULL, NOW()),
('20260208_refresh_tokens.sql', NULL, NOW()),
('20260213_update_escalation_resolution_actions.sql', NULL, NOW()),
('20260215_schema_alignment_push_tokens_part_subcategory.sql', NULL, NOW()),
('20260216_cleanup_orphan_objects.sql', NULL, NOW());
