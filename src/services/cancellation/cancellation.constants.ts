...
export const CANCELLATION_FEES = {
    ...
    DURING_PREPARATION: 0.1, // 10% - During preparation
    IN_DELIVERY: 0.1, // 10% + full delivery fee
    AFTER_DELIVERY: 0.2 // 20% + full delivery fee (7-day return)
} as const;
...
export const FEE_SPLIT = {
    ...
    AFTER_DELIVERY: { platform: 0.1, garage: 0.1 } // 10% each (return processing)
} as const;
...
export const RETURN_POLICY = {
    ...
    FEE_PERCENTAGE: 0.2 // 20% restocking fee
} as const;
