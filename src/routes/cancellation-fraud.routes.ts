 ...
 */
router.get('/return-requests', async (req: Request, res: Response) => {
    try {
        const pool = (global as any).pool;
 ...
 */
router.post('/return-requests/:return_id/approve', async (req: Request, res: Response) => {
    try {
 ...
 */
router.post('/return-requests/:return_id/reject', async (req: Request, res: Response) => {
    try {
        const { return_id } = req.params;
 ...
 */
router.get('/abuse-tracking', async (req: Request, res: Response) => {
    try {
        const pool = (global as any).pool;
 ...
 */
router.post('/abuse-flag', async (req: Request, res: Response) => {
    try {
        const pool = (global as any).pool;
 ...
 */
router.get('/garage-penalties', async (req: Request, res: Response) => {
    try {
        const pool = (global as any).pool;
