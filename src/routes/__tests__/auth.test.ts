...
describe('Authentication API', () => {
    ...
    describe('POST /api/auth/register', () => {
        ...
        it('should hash password before storing', async () => {
            const user = await pool.query('SELECT password_hash FROM users WHERE phone_number = $1', [testPhone]);
    ...
    describe('Password Security', () => {
        ...
        it('should hash passwords with bcrypt', async () => {
            const testUser = await pool.query('SELECT password_hash FROM users WHERE phone_number = $1', [testPhone]);
